...
def load_required_files (all_ips, links, mode=2, ip_version=4, sol_threshold=0.01, geolocation_threshold=0.6, ignore=True):

	# Ideally we want to load things straight away in which case we don't need all_ips and links
	geolocation_latlon_cluster_and_score_map, geolocation_latlon_cluster_and_score_map_sol_validated = generate_latlon_cluster_and_score_map (all_ips, ip_version=ip_version, mode=mode, threshold=sol_threshold)
...
def generate_cable_mapping_for_given_category (category_links, latlon_cluster_and_score_map, category, tree, future_cables, closest_submarine_org, submarine_owners_dict, cable_dict, landing_points_dict, latlon_dict, latlons, save_file = None):
...
def general_cable_mapping_helper (categories_map, latlon_cluster_and_score_map, tree, future_cables, closest_submarine_org, submarine_owners_dict, cable_dict, landing_points_dict, latlon_dict, latlons, max_links_to_process=None, server_id=None, mode=0, ip_version=4):
	...
	for category in categories_map:
		if category != 'de_te':
			...
			if mode == 0:
				...
				cable_mapping = generate_cable_mapping_for_given_category(category_links, latlon_cluster_and_score_map, category, tree, future_cables, closest_submarine_org, submarine_owners_dict, cable_dict, landing_points_dict, latlon_dict, latlons, save_file)
...
def generate_cable_mapping (max_links_to_process=None, max_links_to_process_sol_validated=None, server_id=None, mode=2, ip_version=4, sol_threshold=0.01, geolocation_threshold=0.6, ignore=True):

	links, all_ips = load_all_links_and_ips_data(ip_version=ip_version)
	geolocation_latlon_cluster_and_score_map, geolocation_latlon_cluster_and_score_map_sol_validated, categories_map, categories_map_sol_validated = load_required_files (all_ips, links, mode=mode, ip_version=ip_version, sol_threshold=sol_threshold, geolocation_threshold=geolocation_threshold, ignore=ignore)
...
def generate_cable_mapping_test(mode=2, ip_version=4, sol_threshold=0.01, geolocation_threshold=0.6, ignore=True, max_links_to_process=None, max_links_to_process_sol_validated=None, server_id=None):
