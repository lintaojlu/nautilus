...
def save_cymru_whois_output (cymru_output, ip_version = 4, tags='default'):
	...
	save_directory = Path.cwd() / 'stats/ip2as_data/'

	save_directory.mkdir(parents=True, exist_ok=True)

	with open('stats/ip2as_data/cymru_whois_output_v{}_{}'.format(ip_version, tags), 'wb') as fp:
...
def load_cymru_whois_output(ip_version=4, tags='default', ips_list=[]):
	...
	file_location = 'stats/ip2as_data/cymru_whois_output_v{}_{}'.format(ip_version, tags)
