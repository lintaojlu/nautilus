...
def generate_as_to_org_map_from_caida():
	...
	if not Path('stats/as2org_info.txt').is_file():
		print ('Download data relevant AS2Org info txt file from "https://publicdata.caida.org/datasets/as-organizations/" and save the unzipped file in stats directory')
		sys.exit(1)
